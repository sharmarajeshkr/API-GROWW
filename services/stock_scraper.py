...
async def get_sector_stocks(sector_name="Banking"):
    ...
    async with httpx.AsyncClient() as client:
        ...
        r1 = await client.get(url_filter, headers=headers)
        ...
        r2 = await client.post(url_api, headers=api_headers, json=payload)
